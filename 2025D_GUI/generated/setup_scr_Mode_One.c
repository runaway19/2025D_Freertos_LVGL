...
void setup_scr_Mode_One(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->Mode_One_Change_Button, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Mode_One_Test_Type, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->Mode_One_Test_R, 188, 150);
    ...
    lv_obj_set_style_text_font(ui->Mode_One_Test_R, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Mode_One_Test_Db, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->Mode_One_label_3, "30MHz");
    lv_label_set_long_mode(ui->Mode_One_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Mode_One_label_3, 38, 232);
    ...
    lv_obj_set_style_text_font(ui->Mode_One_label_3, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Mode_One_label_2, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->Mode_One_label_1, "Type");
    ...
    lv_obj_set_style_text_font(ui->Mode_One_label_1, &lv_font_montserratMedium_20, LV_PART_MAIN|LV_STATE_DEFAULT);
