...
void setup_scr_Mode_Two(lv_ui *ui)
{
    ...
    //Write codes Mode_Two_Short
    ui->Mode_Two_Short = lv_label_create(ui->Mode_Two);
    lv_label_set_text(ui->Mode_Two_Short, "Label");
    lv_label_set_long_mode(ui->Mode_Two_Short, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Mode_Two_Short, 184, 154);
    lv_obj_set_size(ui->Mode_Two_Short, 100, 32);

    //Write style for Mode_Two_Short, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Mode_Two_Short, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Mode_Two_Short, &lv_font_montserratMedium_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Mode_Two_Short, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Mode_Two_Short, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Mode_Two_Short, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Mode_Two_Line
    ui->Mode_Two_Line = lv_label_create(ui->Mode_Two);
    lv_label_set_text(ui->Mode_Two_Line, "Label");
    lv_label_set_long_mode(ui->Mode_Two_Line, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Mode_Two_Line, 184, 73);
    lv_obj_set_size(ui->Mode_Two_Line, 100, 32);

    //Write style for Mode_Two_Line, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Mode_Two_Line, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Mode_Two_Line, &lv_font_montserratMedium_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Mode_Two_Line, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Mode_Two_Line, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Mode_Two_Line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
