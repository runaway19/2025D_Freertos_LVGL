...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, TX_1_Pin|TX_2_Pin|TX_3_Pin|TX_4_Pin
                          |TX_5_Pin|TX_6_Pin|TX_7_Pin|TX_8_Pin
                          |TX_9_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           ...
                           PEPin */
  GPIO_InitStruct.Pin = TX_1_Pin|TX_2_Pin|TX_3_Pin|TX_4_Pin
                          |TX_5_Pin|TX_6_Pin|TX_7_Pin|TX_8_Pin
                          |TX_9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = RX_9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(RX_9_GPIO_Port, &GPIO_InitStruct);
