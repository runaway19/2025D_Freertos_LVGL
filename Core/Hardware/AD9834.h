...
/* AD9834 控制引脚 */ 
#define AD9834_Control_Port   GPIOE
#define AD9834_FSYNC  				GPIO_PIN_1 
#define AD9834_SCLK   				GPIO_PIN_2		
#define AD9834_SDATA  				GPIO_PIN_3 		
#define AD9834_RESET  				GPIO_PIN_4		
#define AD9834_FS  						GPIO_PIN_5		
#define AD9834_PS  						GPIO_PIN_6		
...
#define AD9834_FS_SET				HAL_GPIO_WritePin(AD9834_Control_Port, AD9834_FS, GPIO_PIN_SET)
#define AD9834_PS_SET				HAL_GPIO_WritePin(AD9834_Control_Port, AD9834_PS, GPIO_PIN_SET)
...
#define AD9834_FS_RESET			HAL_GPIO_WritePin(AD9834_Control_Port, AD9834_FS, GPIO_PIN_RESET)
#define AD9834_PS_RESET			HAL_GPIO_WritePin(AD9834_Control_Port, AD9834_PS, GPIO_PIN_RESET)
